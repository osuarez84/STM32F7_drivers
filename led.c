...
//					hal_gpio_write_to_pin(GPIOB, SPI_CS_PIN, 1);				// CS to HIGH		
			...
			if(medidasADC_we1 == YES){
				...
				if(contMedidasADC_we1 == NMEDIDASWE1){				// ¿Paramos de tomar medidas...?
					...
					data_out_we1[2] = 'T';
					data_out_we1[3] = 0;
					data_out_we1[4] = (uint8_t)(contPtos_we1 >> 8);
					data_out_we1[5] = (uint8_t)(contPtos_we1);
					data_out_we1[6] = 100;
					data_out_we1[7] = 100;
					data_out_we1[8] = (uint8_t)(contPtos_we1 >> 8);
					data_out_we1[9] = (uint8_t)(contPtos_we1);
					data_out_we1[10] = 0;
					data_out_we1[11] = 0;
					data_out_we1[12] = 0;
					data_out_we1[13] = 'F';
...
//					hal_gpio_write_to_pin(GPIOB, SPI_CS_PIN, 1);				// CS to HIGH		
			...
			if(medidasADC_we2 == YES){
				...
				if(contMedidasADC_we2 == NMEDIDASWE2){				// ¿Paramos de tomar medidas...?
					...
					data_out_we2[2] = 'T';
					data_out_we2[3] = 1;
					data_out_we2[4] = (uint8_t)(contPtos_we2 >> 8);
					data_out_we2[5] = (uint8_t)(contPtos_we2);
					data_out_we2[6] = 100;
					data_out_we2[7] = 100;
					data_out_we2[8] = (uint8_t)(contPtos_we2 >> 8);
					data_out_we2[9] = (uint8_t)(contPtos_we2);
					data_out_we2[10] = 0;
					data_out_we2[11] = 0;
					data_out_we2[12] = 0;
					data_out_we2[13] = 'F';
